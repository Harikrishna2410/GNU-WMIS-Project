...
public class CustomRequest extends Request<JSONObject> {
    ...
    public CustomRequest(int method, String url, Map<String, String> headers,JSONObject jsonObject, Response.Listener<JSONObject> reponseListener, Response.ErrorListener errorListener) {
